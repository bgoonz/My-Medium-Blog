...
iframe.style =
  "font-family: Arial, Helvetica, sans-serif; color: rgb(136, 247, 221); background-color: whitesmoke; border-radius: 25px; position: absolute; font-size: 8px; bottom: 0px; left: 0; width: 30%; border: 3px solid gold; padding: 0px; margin: 2px; overflow: auto; overflow-y: auto; height: 15%; -webkit-border-radius: 15px; -moz-border-radius: 15px; -ms-border-radius: 15px; -o-border-radius: 15px; overflow-wrap: break-word; zoom: 1.1;  resize: both;overflow: auto;z-index: 100;";
