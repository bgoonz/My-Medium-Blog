...
define("ace/mode/mysql_highlight_rules", [
  ...
  const PythonHighlightRules =
    require("./python_highlight_rules").PythonHighlightRules;

  const MysqlHighlightRules = function () {
    const keywords = // http://dev.mysql.com/doc/refman/5.6/en/reserved-words.html
    ...
    const builtinFunctions = // http://dev.mysql.com/doc/refman/5.6/en/func-op-summary-ref.html
