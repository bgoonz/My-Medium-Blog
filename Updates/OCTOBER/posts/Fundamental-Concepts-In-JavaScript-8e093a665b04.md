...
### For starters… here’s a list of JavaScript Skills you would likely be expected to have full command of during an interview.

### The Image below shows that you must scroll about 10-15% of the way down the page to get to the actual interview questions below the JavaScript Cheat Sheet!

<figure><img src="https://cdn-images-1.medium.com/max/1200/1*i3H8uYjFxz-gD0o5ieuhOw.png" class="graf-image" /></figure>
