...
Related documentation: [Configure Your Project](/docs/configuration) , [.gitpod.yml](/docs/config-gitpod-file) , [Docker Configuration](/docs/config-docker) and [Start Tasks](/docs/config-start-tasks)
