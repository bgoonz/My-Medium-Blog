...
-   <a href="/docs/configure" class="text-large active svelte-gpq0pb">Configure</a>
...
Configure Gitpod[<span class="icon icon-link"></span>](#configure-gitpod)
=========================================================================
...
<a href="/docs/getting-started" class="svelte-1kanmwt" title="Previous: Getting Started">Previous</a> <a href="/docs/config-gitpod-file" class="svelte-1kanmwt" title="Next: .gitpod.yml">Next</a>
