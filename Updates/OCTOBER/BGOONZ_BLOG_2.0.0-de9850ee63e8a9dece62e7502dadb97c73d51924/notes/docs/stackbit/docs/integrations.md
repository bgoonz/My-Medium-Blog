...
-   <a href="/docs/integrations" class="text-large active svelte-gpq0pb">Integrations</a>
...
Integrations[<span class="icon icon-link"></span>](#integrations)
=================================================================
...
<a href="/docs/develop/local-companion" class="svelte-1kanmwt" title="Previous: Local Companion">Previous</a> <a href="/docs/gitlab-integration" class="svelte-1kanmwt" title="Next: GitLab">Next</a>
